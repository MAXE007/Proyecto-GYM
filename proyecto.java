...
public class proyecto {
	...
	public static void rut()  {
		...
		// ciclo
		while (i>2) {
			i = Integer.parseInt(JOptionPane.showInputDialog("Usted eligi� una opci�n incorrecta,vuelva a seleccionar su sexo"));
		}
		// funciones 
		...
		// ciclo
		while (j>4) {
			j = Integer.parseInt(JOptionPane.showInputDialog("Usted eligi� una opci�n incorrecta,seleccione nuevamente su rutina"));
		}
		// condicionales
